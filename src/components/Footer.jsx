...
const Column = styled.ul`
  ...
  justify-content: flex-start;
  gap: 0.6rem;
  ${props => props.liststyle === 'true' ? css`list-style: '🔹';` : 'circle'};
  ...
  return (
    <Container>
      <InnerContainer>
        ...
        <RightSide>
          <Column liststyle='true'>
            <li><h2>Contact and Links</h2></li>
            <li><StyledNav to={'/settings/about'}>About Us</StyledNav></li>
            <li><StyledNav to={'/settings/about'}>FAQ</StyledNav></li>
            <li><StyledNav to={'/settings/privacy'}>Privacy Policy</StyledNav></li>
          </Column>
          <Column liststyle='true'>
            <li><h2>Navigation</h2></li>
            <li><StyledNav to={'/searchBooks'}>Explore</StyledNav></li>
            <li><StyledNav to={'/settings'}>Settings</StyledNav></li>
            <li><StyledNav to={'/myBooks'}>My Books</StyledNav></li>
            <li><StyledNav to={'/settings/security'}>Security</StyledNav></li>
            <li><StyledNav to={'/settings/personal-information'}>Personal Information</StyledNav></li>
          </Column>
          <Column>
